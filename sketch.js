...
function createAboutPage() {
  return `
    <html><body style="
      ...
      height: 100vh; margin: 0; background: transparent; color: #333; text-align: center;">
      <div>
        <h1 style="color: #000; font-size: 36px;">自我介紹</h1>
        <p style="color: #000; font-size: 24px;">大家好，我的名字是吳雨霏，目前就讀淡江大學教育科技學系大三。</p>
      </div>
    </body></html>
  `;
}
